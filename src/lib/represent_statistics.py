...
This module contains methods of saving errors' statistics
    - print_statistics - generates str with convenient for perception output \
        (logname, sender, event first; time or time range for each error \
        message)
    - dump_json - saves dictionary with errors' information to .js file \
                    (time first).\
        Used for creating interactive chart \
